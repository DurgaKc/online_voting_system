                ...
                <div class="card-body">
                  <div class="d-md-flex align-items-center">
                    <div>
                      ...
                      <h5 class="card-subtitle">Overview of highest vote</h5>
                    </div>
                  </div>
                  <div class="row">
                    <!-- column -->
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="bg-dark p-10 text-white text-center">
                            ...
                            <h5 class="mb-0 mt-1">22540</h5>
                            <small class="font-light">Total voters</small>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="bg-dark p-10 text-white text-center">
                            <i class="mdi mdi-plus fs-3 font-16"></i>
                            <h5 class="mb-0 mt-1">1290</h5>
                            <small class="font-light">New voters</small>
                          </div>
                        </div>
                        <div class="col-6 mt-3">
                          <div class="bg-dark p-10 text-white text-center">
                            <i class="mdi mdi-cart fs-3 mb-1 font-16"></i>
                            <h5 class="mb-0 mt-1">20608</h5>
                            <small class="font-light">Total vote</small>
                          </div>
                        </div>
                        <div class="col-6 mt-3">
                          <div class="bg-dark p-10 text-white text-center">
                            <i class="mdi mdi-tag fs-3 mb-1 font-16"></i>
                            <h5 class="mb-0 mt-1">540</h5>
                            <small class="font-light">Total reject vote</small>
                          </div>
                        </div>
                        <div class="col-6 mt-3">
                          <div class="bg-dark p-10 text-white text-center">
                            <i class="mdi mdi-table fs-3 mb-1 font-16"></i>
                            <h5 class="mb-0 mt-1">105</h5>
                            <small class="font-light">total parties</small>
                          </div>
                        </div>
                        <div class="col-6 mt-3">
                          <div class="bg-dark p-10 text-white text-center">
                            <i class="mdi mdi-web fs-3 mb-1 font-16"></i>
                            <h5 class="mb-0 mt-1">1o5</h5>
                            <small class="font-light">total ballot</small>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row">
                    ...
                    <div class="comment-text w-100">
                      ...
                      <span class="mb-3 d-block"
                        >Online voting not only increases convenience for everyone involved, 
                        but it also helps protect elections from a major risk to their integrity — human error.
                      </span>
                      <div class="comment-footer">
