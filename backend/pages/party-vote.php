            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <?php
                  $query = "SELECT party_name, image, total_voting FROM party ORDER BY total_voting DESC";
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th class="align-center"><h4>Total Votes</h4></th>
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <td class="align-center"><?php echo $total_vote; ?></td>
